...
const CustomTrip = () => {
  ...
  const handleInputChange = (field, value) => {
    ...
    // Validate email and phone fields in real-time
    if (field === 'email') {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 bg-white border rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-900 ${
