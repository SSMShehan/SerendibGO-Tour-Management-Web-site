...
const generateGuidePDFReport = asyncHandler(async (req, res) => {
  try {
    ...
    let errorMessage = 'Error generating guide PDF report';
    if (error.message.includes('Chrome')) {
      errorMessage = 'PDF generation failed: Chrome browser not found. Please contact support.';
    } else if (error.message.includes('timeout')) {
      errorMessage = 'PDF generation timed out. Please try again.';
    } else if (error.message.includes('puppeteer')) {
      errorMessage = 'PDF generation failed: Browser error. Please contact support.';
    }
